  ...
  IOCTL(TUNGETDEVNETNS,  IOC_R, TYPE_NULL)
     ...
     IOCTL(MEGASAS_IOC_FIRMWARE32, IOC_RW, MK_PTR(MK_STRUCT(STRUCT_compat_megasas_iocpacket)))
     IOCTL(MEGASAS_IOC_FIRMWARE, IOC_RW, MK_PTR(MK_STRUCT(STRUCT_megasas_iocpacket)))
     IOCTL(MEGASAS_IOC_GET_AEN, IOC_W, MK_PTR(MK_STRUCT(STRUCT_megasas_aen)))
